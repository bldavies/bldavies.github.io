...
I use the [`jaccard`](https://github.com/bldavies/pokenet/blob/master/code/jaccard.R) function described in [my previous blog post](https://bldavies.github.io/2018/03/01/pokenet.html#estimating-the-strength-of-species-social-ties) to determine the similarity between two authors from their authorship counts.
